...
function GalleryScene({
	...
	// Handle scroll input - don't prevent default to allow natural scroll
	const handleWheel = useCallback(
		(event: WheelEvent) => {
			// Only consume the event if the gallery is being actively used
	...
	// Auto-play logic - resume after 3 seconds of inactivity
	useEffect(() => {
