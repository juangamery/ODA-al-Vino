  ...
  return [
    {
      ...
      status: "available",
      ars: "176.400",
      arsMisioneros: "144.900",
      pyg: "793.800",
      voucherBrl: "200",
      voucherArs: "56.000",
      voucherMisioneros: "46.000",
      voucherPyg: "252.000",
      dates: "30/04-05/06",
    },
    {
      ...
      status: "next",
      ars: "194.600",
      arsMisioneros: "159.850",
      pyg: "875.700",
      voucherBrl: "210",
      voucherArs: "58.800",
      voucherMisioneros: "48.300",
      voucherPyg: "264.600",
      dates: "06/06-05/07",
    },
    {
      ...
      status: "upcoming",
      ars: "214.200",
      arsMisioneros: "175.950",
      pyg: "963.900",
      voucherBrl: "230",
      voucherArs: "64.400",
      voucherMisioneros: "52.900",
      voucherPyg: "289.800",
      dates: "06/07-05/08",
    },
    {
      ...
      status: "final",
      ars: "235.200",
      arsMisioneros: "193.200",
      pyg: "1.058.400",
      voucherBrl: "252",
      voucherArs: "70.560",
      voucherMisioneros: "57.960",
      voucherPyg: "317.520",
      dates: "06/08-03/09",
    },
  ];
            ...
            <div className="lg:sticky lg:top-32 bg-gradient-to-br from-wine via-plum to-wine p-6 md:p-10 lg:p-14 shadow-2xl relative" style={{
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4 mb-3 md:mb-4">
                ...
                <div className="bg-plum/10 border-l-4 border-plum rounded-lg p-4 md:p-6">
                  ...
                  <p className="text-paper text-xs font-bold uppercase tracking-widest">
                    {t("ticketsVoucherLocation", language)}
                  </p>
                </div>

                {/* Sponsor: Rio Uruguay */}
                <div className="rounded-lg p-4 md:p-6 flex flex-col items-center justify-center gap-3 text-center" style={{ backgroundColor: "#770047" }}>
