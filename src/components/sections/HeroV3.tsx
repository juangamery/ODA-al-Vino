    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center flex-1 px-4 md:px-6 pt-16 md:pt-32 pb-8 md:pb-16">
        ...
        >
          ...
          <p
            ref={eyebrowRef}
            className="text-wine/50 text-[10px] md:text-sm tracking-widest uppercase font-bold mb-3 md:mb-4 opacity-0"
          >
          ...
          <div ref={titleRef} className="mb-0 opacity-0" style={{ marginTop: 'clamp(0px, 1vw, 35px)' }}>
            ...
            <p className="lato-expanded text-wine font-bold tracking-widest mt-0 md:mt-4" style={{ fontSize: 'clamp(11px, 2.5vw, 14px)' }}>
              {t("heroYear", language)}
            </p>
          </div>
        </div>
